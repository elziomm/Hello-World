    ...
    const criaLista = ( post ) => {
        ...
        post.map(autor => {
            ...
            autor_um.innerHTML = "\n" +
                ...
                "              <a class=\"btn float-right\" onclick=\"edit(teste)\" data-toggle=\"modal\" data-target=\"#exampleModal\" type=\"button\"><img src=\"img/pencil.png\" width=\"40px\"></a>\n" +
...
function edit(teste){
    document.querySelector("[name='autor']").value = teste.autor;
    document.querySelector("[name='titulo']").value = teste.titulo;
    document.querySelector("[name='descricao']").value = teste.descricao;    
}